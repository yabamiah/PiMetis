...
void detection_loop(VideoStreamer& streamer)
{
    ...
    while (true)
    {
        ...
        if (person_counter.load() >= limit_person)
        {
            ...
            pi_metis_bot.send_warning("O limite de pessoas foi ultrapassada.", "/home/yaba/Sandbox/PiMetis/pi_metis_ia/person.jpg");
        ...
        if (object_counter.load() != 0)
        {
            ...
            pi_metis_bot.send_warning("Um objeto perigoso foi detectado.", "/home/yaba/Sandbox/PiMetis/pi_metis_ia/object.jpg");
            std::this_thread::sleep_for(std::chrono::seconds(30));
