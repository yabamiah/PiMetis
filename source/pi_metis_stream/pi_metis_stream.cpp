...
{
    system("pkill -9 -f ngrok");    
    system("ngrok http 5000 --log=stdout > /home/yaba/Sandbox/PiMetis/source/pi_metis_stream/ngrok.log &");
    std::this_thread::sleep_for(std::chrono::seconds(5));

    std::ifstream log_file("/home/yaba/Sandbox/PiMetis/source/pi_metis_stream/ngrok.log");
    std::string line;
    ...
    std::ofstream link_file("/home/yaba/Sandbox/PiMetis/source/servidor_link.txt", std::ios::out | std::ios::trunc);
